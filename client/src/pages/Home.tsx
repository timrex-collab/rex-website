      ...
      <section className="py-16 md:py-20 lg:py-24 bg-card">
        <div className="max-w-7xl mx-auto px-4 md:px-6 lg:px-8">
          <div className="max-w-3xl mb-12">
            ...
            <p className="text-base text-slate-600 leading-relaxed">Als traditionsreiche Dachdeckerei in Bochum führt die Rex Bedachungs GmbH als Meisterbetrieb seit 1984 Dacharbeiten im gesamten Ruhrgebiet durch – von der Steildachsanierung über Flachdachabdichtung bis zum VELUX-Fenstereinbau.</p>
          </div>
