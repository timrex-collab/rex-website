...
const ablaufSteps = [
  ...
  { name: "Angebot und Terminplanung", text: "Transparentes Angebot mit vollständiger Leistungsaufstellung – kein versteckter Nachtragsaufwand." },
...
const faqItems = [
  {
    ...
    answer: "Rex Bedachungs GmbH führt Velux Dachfenster-Austausch in Bochum ab 1.000 € inkl. Lieferung und Einbau durch – je nach Modell, Größe und notwendigen Nebenarbeiten. Nach kostenlosem Aufmaß erhalten Sie ein transparentes Angebot.",
  },
  {
...
const howToSchema = JSON.stringify({
  ...
  "step": [
    ...
    { "@type": "HowToStep", "position": 3, "name": "Angebot und Terminplanung", "text": "Transparentes Angebot mit vollständiger Leistungsaufstellung." },
...
export default function VeluxAustausch() {
  ...
  return (
    <>
      <Helmet>
        <title>VELUX Dachfenster austauschen – Bochum &amp; Umgebung</title>
        <meta
          name="description"
          content="Altes Dachfenster raus, neues rein – meist an einem Arbeitstag. Verglasung, Eindeckrahmen und Förderprüfung inklusive. Autorisierter VELUX-Partner."
        />
  ...
  "itemListElement": [
    ...
    {"@type":"ListItem","position":3,"name":"Velux Dachfenster Austausch Bochum","item":"https://www.rex-bedachung.de/velux-dachfenster-austausch-bochum"}
      ...
      >
        ...
        <div className="relative z-10 max-w-7xl mx-auto">
          ...
          <p className="text-sm text-slate-300 font-medium" data-testid="text-trust-badge">
            Autorisierter VELUX-Partner &bull; Meisterbetrieb seit 1984 &bull; Bochum &amp; Ruhrgebiet
          </p>
          <a
            href="/velux-preisrechner-bochum"
            className="inline-block mt-2 text-sm text-slate-200 underline underline-offset-2 hover:text-white transition-colors"
            data-testid="link-hero-preisrechner"
          >
            Preis in 3 Schritten berechnen →
          </a>
        </div>
      </section>
      ...
      {/* ── Preisrechner-Sektion (D27: nach oben verschoben) ── */}
      <section className="py-12 px-4 bg-background" data-testid="section-preisrechner">
        <div className="max-w-4xl mx-auto">
          <div className="rounded-xl bg-gradient-to-r from-red-700 to-red-500 p-6 text-white shadow-lg">
            <h2 className="mb-2 text-xl md:text-2xl font-bold">VELUX Preisrechner Bochum</h2>
            ...
            <a
              ...
              data-testid="button-preisrechner-section"
            >
      ...
      <section className="py-16 px-4 bg-background" data-testid="section-preise">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-muted-foreground text-center mb-10 max-w-3xl mx-auto" data-testid="text-preise-intro">
            Rex Bedachungs GmbH nennt realistische Preisrahmen – kein verbindlicher Preis ohne Aufmaß, aber echte Orientierung für Ihre Planung.
          </p>
      ...
      <section className="py-16 px-4 bg-background" data-testid="section-warum-rex">
        <div className="max-w-5xl mx-auto">
          <h2 className="text-2xl md:text-3xl font-bold text-center mb-10 text-foreground" data-testid="heading-warum-rex">
            Warum Rex Bedachungs GmbH als autorisierter VELUX-Partner in Bochum
          </h2>
          <div className="grid sm:grid-cols-2 gap-8">
            <div className="flex items-start gap-3" data-testid="item-usp-0">
              ...
              <div>
                ...
                <p className="text-sm text-slate-600 mt-2">Als autorisierter VELUX-Partner in Bochum führt die Rex Bedachungs GmbH den Dachfensteraustausch gemäß den aktuellen Vorgaben des Gebäudemodernisierungsgesetzes (GModG) durch – Montage und Abdichtung aus einer Hand, in der Regel innerhalb eines Arbeitstages.</p>
              </div>
            </div>
      ...
      <section className="py-16 px-4 bg-background" data-testid="section-regionen">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-muted-foreground leading-relaxed text-base md:text-lg flex items-center justify-center gap-2 flex-wrap" data-testid="text-regionen">
            ...
            Rex Bedachungs GmbH tauscht Velux Dachfenster in Bochum, Herne, Castrop-Rauxel, Witten, Hattingen, Wattenscheid, Altenbochum, Ehrenfeld, Langendreer und dem gesamten Ruhrgebiet aus – termingerecht, zuverlässig und zu fairen Preisen.
          </p>
        </div>
      </section>
