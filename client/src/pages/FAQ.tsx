  ...
  const faqCategories: FaqCategory[] = [
      ...
      questions: [
        {
          ...
          answer:
            "Ja – in der Regel ist die Erstellung eines Angebots ist für Sie kostenlos und erfolgt unverbindlich.\nNach einer ausführlichen Begutachtung erhalten Sie von uns ein transparent kalkuliertes Angebot.\n\nBei ausführlichen Berechnungen und Kalkulationsverfahren behalten wir uns vor, eine Pauschale ( richtet sich nach Projektgröße ) zu berechnen, die nach Auftragserteilung verrechnet werden kann.",
        },
        {
          question: "Wie läuft die Angebotserstellung ab?",
          answer:
            "Zunächst vereinbaren wir einen Besichtigungstermin vor Ort, um Ihr Dach und Ihr Vorhaben genau kennenzulernen. Nach dieser Begutachtung planen wir die erforderlichen Arbeiten und erstellen eine detaillierte Kalkulation. In der Regel erhalten Sie innerhalb weniger Tage ihr schriftliches Angebot, in dem alle Leistungen und Kosten klar aufgeführt sind.",
        },
        {
          question:
            "Bleibt der angebotene Preis verbindlich, oder kommen im Nachhinein Mehrkosten?",
          answer:
            "Unsere Angebote sind sorgfältig kalkuliert. Sollten während der Arbeiten dennoch unvorhergesehene Umstände auftreten, sprechen wir Sie umgehend transparent darauf an und legen gemeinsam fest, wie wir weiter vorgehen. Überraschende Nachträge werden Sie bei uns nicht erleben.",
        },
        {
    ...
    },
    {
      ...
      questions: [
        ...
        {
          question:
            "Übernehmen Sie auch sehr kleine Reparaturen (z.B. einzelne Dachziegel austauschen)?",
          answer:
            "Ja – selbstverständlich führen wir auch Kleinstreparaturen zuverlässig für Sie aus. Egal ob ein einzelner Ziegel locker oder zerbrochen ist, ein kurzer Abschnitt der Dachrinne leckt oder eine kleine Stelle neu abgedichtet werden muss: Solche Arbeiten erledigen wir prompt und sorgfältig. Auch wenn es 'nur' eine Kleinigkeit ist, lohnt sich die Reparatur, um größeren Folgeschäden vorzubeugen.",
        },
      ],
    },
    {
    ...
    },
    {
      ...
      questions: [
        ...
        {
          question:
            "Welches Material ist für Dachrinnen am besten geeignet – Kunststoff, Zink oder Kupfer?",
          answer:
      ...
      <Helmet>
        ...
        <script type="application/ld+json">{JSON.stringify({
          ...
          "itemListElement": [
            ...
            { "@type": "ListItem", "position": 2, "name": "FAQ", "item": "https://www.rex-bedachung.de/faq" }
          ]
        })}</script>
      </Helmet>
      <OrganizationSchema />
        ...
        <div className="max-w-5xl mx-auto px-4 md:px-6 lg:px-8">
          ...
          <div className="mt-16 p-8 bg-card border border-card-border rounded-md text-center">
            ...
            <p className="text-muted-foreground mb-6 max-w-2xl mx-auto">
              ...
              Ihre Fragen persönlich und erstellen Ihnen ein individuelles
              Angebot für Ihr Dachprojekt.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center flex-wrap">
              <a
                href="tel:+49234583100"
                className="pulse-ring cta-pulse inline-flex items-center justify-center gap-2 min-h-9 px-4 py-2 rounded-md text-sm font-medium bg-primary text-primary-foreground border border-primary-border hover-elevate active-elevate-2"
