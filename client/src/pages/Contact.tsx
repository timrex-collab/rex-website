  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Kontakt zu Rex Bedachungs GmbH Bochum – Telefon: 0234-583100, E-Mail: info@rex-bedachung.de. Jetzt kostenloses Aufmaß und persönliche Beratung vor Ort anfragen." />
