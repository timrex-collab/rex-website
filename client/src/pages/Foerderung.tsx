...
export default function Foerderung() {
  ...
  return (
    <>
      <Helmet>
        <title>BAFA & KfW Förderung Dachsanierung Bochum | Rex Bedachungs GmbH</title>
        <meta
          name="description"
          content="Bis zu 20% staatliche Förderung für Dachsanierung & Velux-Dachfenster in Bochum. BAFA, KfW und Steuerbonus verständlich erklärt. Rex Bedachungs GmbH – Ihr Meisterbetrieb."
        />
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {grants.map((g, i) => (
            <div key={i} className="bg-card rounded-md shadow-xl p-8 border border-border hover:border-blue-300 transition group">
              ...
              <h3 className="text-2xl font-bold mb-4 group-hover:text-blue-700 transition-colors">{g.title}</h3>
