...
const VeluxPreisrechnerBochum = lazy(() => import("@/pages/VeluxPreisrechnerBochum"));
const DachPhotovoltaikBochum = lazy(() => import("@/pages/DachPhotovoltaikBochum"));
  ...
  return (
    <Switch>
      ...
      <Route path="/dachsanierung-bochum" component={DachsanierungBochum} />
          <Route path="/dachrinne-bochum" component={DachrinnenBochum} />
      ...
      <Route path="/dach-photovoltaik-bochum" component={DachPhotovoltaikBochum} />
...
function App() {
  // Die Route dient der ChunkErrorBoundary als key: Ein Klick auf einen anderen Link
  // setzt einen Fehlerzustand damit automatisch zurueck.
