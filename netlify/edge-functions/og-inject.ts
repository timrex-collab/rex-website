...
const routes: Record<string, OGData> = {
  "/": {
    ...
    description: "Ihr Dachdecker in Bochum seit über 30 Jahren. Flachdach, Steildach, Dachsanierung, Bauklempnerei. Jetzt kostenlos anfragen: +49 234 583100.",
    image: DEFAULT_IMAGE,
    imageWidth: "1200",
    imageHeight: "630",
  },
  "/flachdach-bochum": {
    ...
    description: "Flachdach-Experten in Bochum: Abdichtung, Sanierung, Neubau und Gründach. Kostenlose Beratung. Tel. +49 234 583100.",
  ...
  "/steildach-bochum": {
    ...
    description: "Steildach-Arbeiten in Bochum: Neueindeckung, Sanierung, Aufsparrendämmung. BAFA/KfW-gefördert. Tel. +49 234 583100.",
  ...
  "/dachreparatur-bochum": {
    ...
    description: "Dachreparatur in Bochum: Sturmschäden, undichte Stellen, Ziegel tauschen. Schnelle Reaktionszeit. Tel. +49 234 583100.",
  ...
  "/bauklempnerei-bochum": {
    ...
    description: "Bauklempnerei in Bochum: Dachrinnen, Fallrohre, Blechverkleidungen, Dachabdichtungen. Tel. +49 234 583100.",
  ...
  "/dachwartung-bochum": {
    ...
    description: "Professionelle Dachwartung in Bochum: Inspektion, Wartung, Schadensprävention. Regelmäßige Dachpflege spart Kosten. Tel. +49 234 583100.",
  ...
  "/dachfenster-bochum": {
    ...
    description: "Dachfenster in Bochum: Einbau, Austausch und Reparatur. Velux-Fachpartner. Kostenlose Beratung. Tel. +49 234 583100.",
  ...
  "/gruendach-dachbegrunung-bochum": {
    ...
    description: "Gründach-Experten in Bochum: extensive und intensive Dachbegrünung. Förderung möglich. Tel. +49 234 583100.",
  ...
  "/solarpflicht": {
    ...
    description: "Solarpflicht NRW: Wer ist betroffen? Was kostet es? Rex Bedachung berät Eigentümer in Bochum. Tel. +49 234 583100.",
    image: DEFAULT_IMAGE,
    imageWidth: "1200",
    imageHeight: "630",
  },
  "/velux-dachfenster-austausch-bochum": {
    ...
    description: "Velux Dachfenster austauschen in Bochum: GGL, GGU, GPU, Integra. Festpreis ab 1.800 €. Zertifizierter Velux-Partner. Tel. +49 234 583100.",
    image: `${BASE_URL}/images/velux-dachfenster-einbau-bochum-fachbetrieb.webp`,
    imageWidth: "1200",
    imageHeight: "630",
  },
  "/velux-dachfenster-rolllaeden-bochum": {
    ...
    description: "Velux Rollläden für Dachfenster in Bochum: Montage, Austausch, Reparatur. Zertifizierter Velux-Partner. Tel. +49 234 583100.",
  ...
  "/leistungen": {
    ...
    description: "Alle Dachdeckerleistungen in Bochum: Flachdach, Steildach, Reparatur, Bauklempnerei, Gründach und mehr. Tel. +49 234 583100.",
    image: DEFAULT_IMAGE,
    imageWidth: "1200",
    imageHeight: "630",
  },
  "/ueber-uns": {
    ...
    description: "Rex Bedachungs GmbH – Ihr Dachdecker in Bochum seit über 30 Jahren. Inhabergeführt, regional verwurzelt. Tel. +49 234 583100.",
  ...
  "/kontakt": {
    ...
    description: "Kontakt zu Rex Bedachung Bochum: Paulinenstraße 22, 44799 Bochum. Tel. +49 234 583100. Kostenlose Beratung und Angebote.",
    image: DEFAULT_IMAGE,
    imageWidth: "1200",
    imageHeight: "630",
  },
  ...
  "/karriere": {
    ...
    description: "Karriere bei Rex Bedachung Bochum: Stellenangebote für Dachdecker, Auszubildende und Fachkräfte. Jetzt bewerben. Tel. +49 234 583100.",
    image: DEFAULT_IMAGE,
    imageWidth: "1200",
    imageHeight: "630",
  },
...
export default async function handler(request: Request, context: Context) {
  ...
  const ogData = routes[pathname] ?? {
    ...
    description: "Ihr Dachdecker in Bochum. Tel. +49 234 583100.",
    image: DEFAULT_IMAGE,
    imageWidth: "1200",
    imageHeight: "630",
  };
